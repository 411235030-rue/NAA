...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Da(e,t,n){let r=new Float32Array(pa),i=new q(0,1,0);return new li({name:`SphericalGaussianBlur`,defines:{n:pa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oa(){return new li({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ka(){return new li({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Aa(),fragmentShader:`
	...
	`}var ja=class extends Pt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Yr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var rs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function is(e,t){let n=rs[t];return n===void 0?(U(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var as=new q;function os(){return Y.getLuminanceCoefficients(as),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${as.x.toFixed(4)}, ${as.y.toFixed(4)}, ${as.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`;function bc({horizonColor:e=`#5227ff`,waveColor:t=`#ff9ffc`,crestColor:n=`#ffffff`,speed:r=.4,amplitude:i=2.5,waveScale:a=.6,waveRatio:o=.9,swell:s=35,turbulence:l=20,tilt:u=1.11,zoom:d=1,height:f=5.5,fogDepth:p=15,detail:m=`medium`,brightness:h=1,opacity:g=1,mouseInteraction:_=!0,parallaxStrength:v=.5,grain:y=!0,grainIntensity:b=.05,className:x=``}){let S=(0,c.useRef)(null);return(0,c.useEffect)(()=>{let c=S.current;if(!c)return;let x=new gc({alpha:!0,antialias:!1,premultipliedAlpha:!1,powerPreference:`high-performance`});x.setClearColor(0,0);let C={iTime:{value:0},iResolution:{value:new K(1,1)},uSpeed:{value:r},uAmplitude:{value:i},uWaveScale:{value:a},uWaveRatio:{value:o},uSwell:{value:s},uTurbulence:{value:l},uTilt:{value:u},uZoom:{value:d},uHeight:{value:f},uFogDepth:{value:p},uSteps:{value:_c[m]},uBrightness:{value:h},uOpacity:{value:g},uGrain:{value:+!!y},uGrainIntensity:{value:b},uMouse:{value:new K(.5,.5)},uParallax:{value:v},uEnableMouse:{value:_},uHorizonColor:{value:new X(e)},uWaveColor:{value:new X(t)},uCrestColor:{value:new X(n)}},w=new ei(2,2),T=new ui({vertexShader:vc,fragmentShader:yc,uniforms:C,glslVersion:Je,transparent:!0,depthWrite:!1,depthTest:!1}),E=new Lr(w,T);E.frustumCulled=!1;let D=new bn,ee=new Ai;D.add(E);let O=x.domElement;Object.assign(O.style,{width:`100%`,height:`100%`,display:`block`}),c.appendChild(O);let k=new K(.5,.5),A=new K(.5,.5),j=new K,M=0,N=!0,P=!document.hidden,F=performance.now(),te=()=>{let e=c.getBoundingClientRect(),t=Math.max(1,Math.floor(e.width)),n=Math.max(1,Math.floor(e.height)),r=Math.sqrt(16e5/(t*n)),i=Math.max(1,Math.min(window.devicePixelRatio||1,1.5,r));x.setPixelRatio(i),x.setSize(t,n,!1),x.getDrawingBufferSize(j),C.iResolution.value.copy(j)},ne=e=>{let t=O.getBoundingClientRect();!t.width||!t.height||k.set((e.clientX-t.left)/t.width,1-(e.clientY-t.top)/t.height)},re=()=>k.set(.5,.5),ie=e=>{C.iTime.value=(e-F)*.001,A.lerp(k,.05),C.uMouse.value.copy(A),x.render(D,ee),M=window.requestAnimationFrame(ie)},ae=()=>{N&&P&&M===0&&(M=window.requestAnimationFrame(ie))},oe=()=>{M!==0&&(window.cancelAnimationFrame(M),M=0)},se=new ResizeObserver(te);se.observe(c);let I=new IntersectionObserver(([e])=>{N=e.isIntersecting,N?ae():oe()});I.observe(c);let L=()=>{P=!document.hidden,P?ae():oe()};return O.addEventListener(`pointermove`,ne,{passive:!0}),O.addEventListener(`pointerleave`,re),document.addEventListener(`visibilitychange`,L),te(),ae(),()=>{oe(),se.disconnect(),I.disconnect(),O.removeEventListener(`pointermove`,ne),O.removeEventListener(`pointerleave`,re),document.removeEventListener(`visibilitychange`,L),w.dispose(),T.dispose(),x.dispose(),x.forceContextLoss(),O.remove()}},[i,h,n,m,p,y,b,f,e,_,g,v,r,s,u,l,t,o,a,d]),(0,$.jsx)(`div`,{ref:S,className:`gradient-waves-container ${x}`.trim()})}function xc({className:e=``,children:t,style:n,onPointerMove:r,onPointerLeave:i,...a}){function o(e){let t=e.currentTarget.getBoundingClientRect();e.currentTarget.style.setProperty(`--glass-pointer-x`,`${e.clientX-t.left}px`),e.currentTarget.style.setProperty(`--glass-pointer-y`,`${e.clientY-t.top}px`),r?.(e)}function s(e){e.currentTarget.style.removeProperty(`--glass-pointer-x`),e.currentTarget.style.removeProperty(`--glass-pointer-y`),i?.(e)}return(0,$.jsxs)(`section`,{className:`glass-card ${e}`.trim(),style:n,onPointerMove:o,onPointerLeave:s,...a,children:[(0,$.jsx)(`span`,{className:`glass-card__noise`,"aria-hidden":`true`}),(0,$.jsx)(`span`,{className:`glass-card__shine`,"aria-hidden":`true`}),(0,$.jsx)(`div`,{className:`glass-card__content`,children:t})]})}var Sc=2,Cc=2,wc=.25,Tc=(0,c.memo)(function({logos:e,speed:t=120,direction:n=`left`,logoHeight:r=28,gap:i=32,pauseOnHover:a=!0,hoverSpeed:o,fadeOut:s=!1,scaleOnHover:l=!1,ariaLabel:u=`使用技術`,className:d=``,style:f}){let p=(0,c.useRef)(null),m=(0,c.useRef)(null),h=(0,c.useRef)(null),[g,_]=(0,c.useState)(0),[v,y]=(0,c.useState)(Sc),[b,x]=(0,c.useState)(!1),S=(0,c.useCallback)(()=>{let e=p.current?.clientWidth??0,t=Math.ceil(h.current?.getBoundingClientRect().width??0);t&&(_(t),y(Math.max(Sc,Math.ceil(e/t)+Cc)))},[]);(0,c.useEffect)(()=>{S();let e=new ResizeObserver(S);return p.current&&e.observe(p.current),h.current&&e.observe(h.current),window.addEventListener(`load`,S),()=>{e.disconnect(),window.removeEventListener(`load`,S)}},[e,i,r,S]),(0,c.useEffect)(()=>{let e=m.current;if(!e||g<=0)return;let r=0,i=null,s=0,c=0,l=Math.abs(t)*(n===`left`?1:-1),u=o??(a?0:l),d=t=>{i===null&&(i=t);let n=Math.max(0,t-i)/1e3;i=t,c+=((b?u:l)-c)*(1-Math.exp(-n/wc)),s=((s+c*n)%g+g)%g,e.style.transform=`translate3d(${-s}px, 0, 0)`,r=requestAnimationFrame(d)};return r=requestAnimationFrame(d),()=>cancelAnimationFrame(r)},[n,o,b,a,g,t]);let C=[`logoloop`,s&&`logoloop--fade`,l&&`logoloop--scale-hover`,d].filter(Boolean).join(` `),w=(0,c.useMemo)(()=>({"--logoloop-gap":`${i}px`,"--logoloop-logo-height":`${r}px`,...f}),[i,r,f]);function T(e,t){let n=`node`in e?(0,$.jsx)(`span`,{className:`logoloop__node`,"aria-hidden":`true`,children:e.node}):(0,$.jsx)(`img`,{src:e.src,alt:e.alt,title:e.title??e.alt,loading:`eager`,decoding:`async`,draggable:!1});return(0,$.jsx)(`li`,{className:`logoloop__item`,children:e.href?(0,$.jsx)(`a`,{className:`logoloop__link`,href:e.href,target:`_blank`,rel:`noreferrer noopener`,"aria-label":`前往 ${e.title} 官網`,title:`前往 ${e.title} 官網`,children:n}):n},t)}return(0,$.jsx)(`div`,{ref:p,className:C,style:w,role:`region`,"aria-label":u,children:(0,$.jsx)(`div`,{className:`logoloop__track`,ref:m,onMouseEnter:()=>x(!0),onMouseLeave:()=>x(!1),children:Array.from({length:v},(t,n)=>(0,$.jsx)(`ul`,{className:`logoloop__list`,"aria-hidden":n>0,ref:n===0?h:void 0,children:e.map((e,t)=>T(e,`${n}-${t}`))},`copy-${n}`))})})}),Ec=[{src:`https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg`,alt:`React`,title:`React`,href:`https://react.dev/`},{src:`https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/typescript/typescript-original.svg`,alt:`TypeScript`,title:`TypeScript`,href:`https://www.typescriptlang.org/`},{src:`https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vitejs/vitejs-original.svg`,alt:`Vite`,title:`Vite`,href:`https://vite.dev/`},{src:`https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/threejs/threejs-original.svg`,alt:`Three.js`,title:`Three.js`,href:`https://threejs.org/`},{src:`https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/csharp/csharp-original.svg`,alt:`C Sharp`,title:`C#`,href:`https://learn.microsoft.com/dotnet/csharp/`},{src:`https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/dotnetcore/dotnetcore-original.svg`,alt:`ASP.NET Core`,title:`ASP.NET Core`,href:`https://dotnet.microsoft.com/apps/aspnet`},{src:`https://www.assistant-ui.com/favicon.ico`,alt:`assistant-ui`,title:`assistant-ui`,href:`https://www.assistant-ui.com/`},{src:`https://reactbits.dev/favicon.ico`,alt:`React Bits`,title:`React Bits`,href:`https://reactbits.dev/`},{src:`https://magicui.design/favicon.ico`,alt:`Magic UI`,title:`Magic UI`,href:`https://magicui.design/`}];function Dc({onLogin:e}){let[t,n]=(0,c.useState)(``),[r,l]=(0,c.useState)(``),[u,d]=(0,c.useState)(``),[f,p]=(0,c.useState)(!1),m=(0,c.useRef)(null),h=(0,c.useRef)(null);(0,c.useEffect)(()=>{m.current?.focus()},[]);async function g(n){n.preventDefault();let i=t.trim();if(!i){d(`請輸入員工帳號`),m.current?.focus();return}if(!r){d(`請輸入密碼`),h.current?.focus();return}d(``),p(!0);try{await e(i,r)}catch(e){d(e instanceof Error?e.message:`登入失敗，請稍後再試。`),l(``),h.current?.focus()}finally{p(!1)}}return(0,$.jsxs)(`main`,{className:`login-page`,children:[(0,$.jsx)(`div`,{className:`login-page__waves`,"aria-hidden":`true`,children:(0,$.jsx)(bc,{horizonColor:`#f0ecff`,waveColor:`#db77d8`,crestColor:`#eeabab`})}),(0,$.jsx)(`div`,{className:`login-page__veil`,"aria-hidden":`true`}),(0,$.jsxs)(xc,{className:`login-card`,"aria-labelledby":`login-title`,children:[(0,$.jsx)(i,{className:`login-card__brand`}),(0,$.jsxs)(`form`,{className:`login-form`,onSubmit:g,noValidate:!0,children:[(0,$.jsx)(`div`,{className:`login-form__eyebrow`,children:`WELCOME BACK`}),(0,$.jsx)(`h1`,{id:`login-title`,children:`歡迎回來`}),(0,$.jsx)(`p`,{children:`使用員工帳號登入，繼續你的護理 AI 對話。`}),(0,$.jsx)(`label`,{htmlFor:`account`,children:`員工帳號`}),(0,$.jsxs)(`div`,{className:`login-input ${u?`login-input--error`:``}`,children:[(0,$.jsx)(s,{size:20,"aria-hidden":`true`}),(0,$.jsx)(`input`,{ref:m,id:`account`,name:`account`,type:`text`,value:t,onChange:e=>{n(e.target.value),u&&d(``)},autoComplete:`username`,placeholder:`例如：N001`,"aria-describedby":u?`account-error`:void 0,"aria-invalid":!!u})]}),(0,$.jsx)(`label`,{htmlFor:`password`,children:`密碼`}),(0,$.jsxs)(`div`,{className:`login-input ${u?`login-input--error`:``}`,children:[(0,$.jsx)(o,{size:20,"aria-hidden":`true`}),(0,$.jsx)(`input`,{ref:h,id:`password`,name:`password`,type:`password`,value:r,onChange:e=>{l(e.target.value),u&&d(``)},autoComplete:`current-password`,placeholder:`請輸入密碼`,"aria-describedby":u?`account-error`:void 0,"aria-invalid":!!u})]}),u&&(0,$.jsx)(`div`,{id:`account-error`,className:`login-form__error`,role:`alert`,children:u}),(0,$.jsxs)(`button`,{className:`login-button`,type:`submit`,disabled:f,children:[(0,$.jsx)(`span`,{children:f?`登入中…`:`進入系統`}),(0,$.jsx)(a,{size:20,"aria-hidden":`true`})]}),(0,$.jsxs)(`div`,{className:`login-note`,children:[(0,$.jsx)(o,{size:17,"aria-hidden":`true`}),(0,$.jsx)(`span`,{children:`帳號僅用於載入與保存你的個人歷史紀錄。`})]})]}),(0,$.jsx)(`footer`,{children:`NAA · Nursing AI Assistant`})]}),(0,$.jsxs)(`div`,{className:`login-tech`,"aria-label":`本系統使用技術`,children:[(0,$.jsx)(`span`,{className:`login-tech__label`,children:`BUILT WITH`}),(0,$.jsx)(Tc,{logos:Ec,speed:42,logoHeight:30,gap:58,pauseOnHover:!0,fadeOut:!0,scaleOnHover:!0,ariaLabel:`本系統使用技術商標`})]})]})}export{Dc as LoginPage};